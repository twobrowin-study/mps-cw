...
Project {
  ...
  property string stdPerLibPath: "mdr32f9q2-std-per-lib/"
  ...
  property string nProportion: "30" // Значение пропорции n
  ...
  Product {
    ...
    Rule {
      ...
      prepare: {
        ...
        args.push("-DNPROPORTION=" + project.nProportion) // Указание пропорции n
